...
# Taken from loani-commonBuildTools.sh:
...
required_package_name_list_non_win="libtool SDL libjpeg zlib libpng SDL_image SDL_gfx freetype SDL_ttf libogg libvorbis SDL_mixer Agar PhysicsFS Ceylan OSDL"

required_package_name_list_win="SDL_win zlib_win libjpeg_win libpng_win SDL_image_win SDL_gfx_win freetype_win SDL_ttf_win libogg_win libvorbis_win SDL_mixer_win PhysicsFS_win Ceylan_win OSDL_win"
