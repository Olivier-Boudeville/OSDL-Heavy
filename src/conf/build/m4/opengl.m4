# In this file are gathered following third-party OpenGL-related autoconf
# macros :
#    - ax_check_gl (http://autoconf-archive.cryp.to/ax_check_gl.html)
#    - ax_check_glu (http://autoconf-archive.cryp.to/ax_check_glu.html)
#    - ax_check_glut is not used, as SDL is used instead.
# and their pre-requesites :
#    - acx_pthread (http://autoconf-archive.cryp.to/acx_pthread.html)
#    - ax_lang_compiler_ms
#      (http://autoconf-archive.cryp.to/ax_lang_compiler_ms.html)
# Thanks to Braden McDaniel <braden@endoframe.com>.
#
# Following variables are set by these macros :
