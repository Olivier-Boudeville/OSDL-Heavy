...
static int clipEncode(Ceylan::Sint16 x, Ceylan::Sint16 y, Ceylan::Sint16 left, Ceylan::Sint16 top, Ceylan::Sint16 right, Ceylan::Sint16 bottom)
{
    int code = 0;
...
int pixelColorNolock(SDL_Surface * dst, Ceylan::Sint16 x, Ceylan::Sint16 y, Ceylan::Uint32 color)
{
    Ceylan::Uint8 alpha;
...
int fastPixelColorNolockNoclip(SDL_Surface * dst, Ceylan::Sint16 x, Ceylan::Sint16 y, Ceylan::Uint32 color)
{
    int bpp;
	Ceylan::Uint8 *p;
...
int aalineColorInt(SDL_Surface * dst, Ceylan::Sint16 x1, Ceylan::Sint16 y1, Ceylan::Sint16 x2, Ceylan::Sint16 y2, Ceylan::Uint32 color, int draw_endpoint)
{
	 ...
	 */
	/*
	 * Not-so-portable version: erradj = ((Ceylan::Uint64)dx << 32) / (Ceylan::Uint64)dy; 
	 */
	erradj = ((dx << 16) / dy) << 16;
	 ...
	 */
	/*
	 * Not-so-portable version: erradj = ((Ceylan::Uint64)dy << 32) / (Ceylan::Uint64)dx; 
	 */
	erradj = ((dy << 16) / dx) << 16;
...
int pixelColorWeightNolock(SDL_Surface * dst, Ceylan::Sint16 x, Ceylan::Sint16 y, Ceylan::Uint32 color, Ceylan::Uint32 weight)
{
    ...
    return (pixelColorNolock(dst, x, y, (color & (Ceylan::Uint32) 0xffffff00) | (Ceylan::Uint32) a));
}
...
int _filledRectAlpha(SDL_Surface * surface, Ceylan::Sint16 x1, Ceylan::Sint16 y1, Ceylan::Sint16 x2, Ceylan::Sint16 y2, Ceylan::Uint32 color, Ceylan::Uint8 alpha)
{
...
int HLineAlpha(SDL_Surface * dst, Ceylan::Sint16 x1, Ceylan::Sint16 x2, Ceylan::Sint16 y, Ceylan::Uint32 color)
{
	...
	case 2:{		/* Probably 15-bpp or 16-bpp */
		if (alpha == 255) {
		    *((Ceylan::Uint16 *) surface->pixels + y * surface->pitch / 2 + x) = color;
		    ...
		    Ceylan::Uint16 *pixel = (Ceylan::Uint16 *) surface->pixels + y * surface->pitch / 2 + x;
		    Ceylan::Uint32 dc = *pixel;
	...
	case 4:{		/* Probably 32-bpp */
		if (alpha == 255) {
		    *((Ceylan::Uint32 *) surface->pixels + y * surface->pitch / 4 + x) = color;
		    ...
		    Ceylan::Uint32 Rshift, Gshift, Bshift, Ashift;
		    Ceylan::Uint32 *pixel = (Ceylan::Uint32 *) surface->pixels + y * surface->pitch / 4 + x;
		    Ceylan::Uint32 dc = *pixel;
