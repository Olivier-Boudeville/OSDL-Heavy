...
namespace OSDL
{
	...
	namespace Video
	{
		...
		namespace TwoDimensional
		{
			 ...
			 *
			 * This kind of points belongs to the 2D namespace, even if they are 3D, since stacking
			 * or homogeneous matrices are useful in a 2D context.
			 *
			 * These integer points are especially useful to handle graphical user interface
			 * elements that can be stacked, such as widgets.
			 *
			 */
	    	class Point3D : public Point
	   		{
	        	...
	        	public:
					 ...
					 * such as : 'return Point3D( _coord[0], _coord[1] ) ;'
					 *
					 */
					 ...
					 *
					 */
					explicit Point3D( const Ceylan::Maths::Linear::Vector3 & source ) throw() ;
					
					 
					/**
					 * Constructor of a three dimensional point from three floating-point
					 * coordinates.
					 *
					 * @note Floating-point coordinates are rounded to nearest integers.
					 *
					 */
	            	Point3D( FloatingPointCoordinate x, FloatingPointCoordinate y,
					...
					/**
					 * Sets this point coordinates from specified 3D vector, whose coordinates are
					 * copied.
					 *
					 * @note Floating-point coordinates are rounded to nearest integers.
					 *
					...
					/**
					 * Translates this point of vector [x,y,z] : adds x to this point's abscissa,
					 * adds y to its ordinate, and z to the depth coordinate.
					 *
					 *
					 */
					...
					/**
					 * Translates all the points in the list of vector [x,y,z] : adds x to each
					 * point's abscissa, adds y to their ordinates, and z to their depth 
					 * coordinates.
					 *
					 *
					 */
