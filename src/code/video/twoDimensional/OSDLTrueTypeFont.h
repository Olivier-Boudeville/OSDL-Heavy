 ...
 *
 * 'struct TTF_Font' could not be forward-declared, as SDL_ttf.h defines it as
 * 'typedef struct _TTF_Font TTF_Font;' which leads to the error "'struct
 * TTF_Font' has a previous declaration as 'struct TTF_Font'", as soon as an
 * implementation file includes SDL_ttf.h.
 *
