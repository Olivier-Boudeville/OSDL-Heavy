...
namespace OSDL 
{
	...
	namespace Video 
	{
		...
		namespace TwoDimensional
		{
			 ...
			 * the screen's sides, according to OpenGL conventions.
			 *
			 * The rectangle lies in the plane z=0 and has sides parallel to the x and y axes.
			 *
			 * @note As long as no different platform is used, it happens that Ceylan::Maths::Real,
			 * which itself is a Ceylan::Float32, i.e. a float, is the same type as GLfloat.
			 * Therefore Ceylan::Maths::Linear::Bipoint instances, which rely on Real, can be used
			 * directly.
			 *
			 */
			class UprightRectangleGL : public Ceylan::TextDisplayable
			{
				...
				// No equality operator defined since relying on floating point values.
				...
				public:
					...
					UprightRectangleGL( const Ceylan::Maths::Linear::Bipoint & upperLeftCorner,
					...
					UprightRectangleGL( const Ceylan::Maths::Linear::Bipoint & upperLeftCorner, 
						OpenGL::GLLength width, OpenGL::GLLength height )  throw() ;
					
					
					/// Two coordinates, width and height define an UprightRectangleGL.
					UprightRectangleGL( OpenGL::GLCoordinate x, OpenGL::GLCoordinate y,
						OpenGL::GLLength width, OpenGL::GLLength height ) throw() ;
					...
					/**
					 * Sets this UprightRectangleGL's upper left corner, width and height 
					 * do not change.
					 *
					 */
					virtual void setUpperLeftCorner( 
						Ceylan::Maths::Linear::Bipoint & newUpperLeftCorner ) throw() ; 
				...
				private:
					 ...
					 *
					 */			 
					explicit UprightRectangleGL( const UprightRectangleGL & source ) throw() ;
