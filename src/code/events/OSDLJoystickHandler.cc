...
void JoystickHandler::update()
{
	...
	/*
	 * Joystick instances have to be deleted so that the _useClassicalJoysticks
	 * value is taken into account (it might have changed since last call).
	 *
	 */
	blank() ;
	...
	/*
	 * This array, faster than a list, will contain _joystickCount pointers to
	 * Joystick instances:
	 *
	 */
