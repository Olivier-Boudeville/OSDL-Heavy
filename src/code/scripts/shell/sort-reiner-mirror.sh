...
${RM} AAspritesharpborder1-4.zip bass.zip enemie-ai-for-more-enemies-final-.zip gesleiste.zip isotiletuteng.zip T_Sbonestut.zip *-Tutorial-* *jumpengine*
...
${MV} *set* *anitown* *beautiful_town* *casino* *cavestuff* *pipeline* *Sdraho* *Sdungeon* *thingmachine_all* ${SETS}
...
# Grounds :
${MV} *earth* *wall* *beach* *cobble* *creek* *sand* *ground* *stonepath* *slope* *grund* *mountain* *pathway* *pfad* *quai* *_road_* *_rocks_* *tiled_floor* *weg_mit_randstein* ${GROUNDS}
