...
namespace OSDL
{
	...
	/**
	 * Describes a CD track, it is just an object-oriented view of an actual
	 * track.
	 *
	 */
	...
	/**
	 * A CD-ROM drive allows to control a particular CD-ROM device attached to
	 * the system.
	 *
	 */
	class OSDL_DLL CDROMDrive : public Ceylan::Object
	{
		...
		public:
			...
			/**
			 * Opens for access this CD-ROM drive, so that the CD that must be
			 * in it can be directly read afterwards, a bit like 'mounting' this
			 * device.
			 *
			 * @note This has nothing to do with opening the drive tray.
			 *
			 * @throw CDROMDriveException if the drive could not be opened, for
			 * example if it is busy, or with no disc, or already opened.
			 *
			 */
			virtual void open() ;
			 ...
			 *
			 * @throw CDROMDriveException if the drive could not be opened, for
			 * example if it is busy and not opened.
			 *
			 */
			virtual void close() ;
			 ...
			 *
			 * @throw CDROMDriveException if an error occurred, for example if
			 * drive was not open.
			 *
			 */
			 ...
			 *
			 * This method cannot be 'const' since status update flag has to be
			 * updated.
			 *
			 */
			 ...
			 *
			 * @throw CDROMDriveException if an error occured, for example if
			 * the drive is not already opened.
			 *
			 */
			 ...
			 *
			 * @throw CDROMDriveException if an error occured, for example if an
			 * invalid track number is given.
			 *
			 */
			 ...
			 *
			 * @note The caller must deallocate the returned track when finished
			 * with it.
			 *
			 * @throw CDROMDriveException if the operation failed.
			 *
			...
			/**
			 * Plays the CD-ROM in drive, starting from specified CD frame, for
			 * specified duration.
			 *
			...
			/**
			 * Plays the CD-ROM in drive, starting from specified CD track, for
			 * specified number of tracks. Frame offsets can be used to start
			 * after the beginning of the starting track and to stop after the
			 * stopping track.
			 *
			 ...
			 * 'startingTrack'.
			 *
			 * @param startingFrameOffset the frame offset, from the beginning
			 * of 'startingTrack', at which to start.
			 *
			 * @param stoppingFrameOffset the frame offset, from the beginning
			 * of the last track (startingTrack+numberOfTracks), at which to end
			 * playing.
			 *
			 * @throw CDROMDriveException if an error occured.
			 *
			...
			/**
			 * Returns the number of CD frames corresponding to the specified
			 * time.
			 *
			 * @param duration the duration in seconds to convert into CD
			 * frames.
			 *
			 */
			...
			/**
			 * Returns the duration in seconds corresponding to the specified
			 * number of CD frames.
			 *
			 * @param duration the duration in seconds to convert into CD
			 * frames.
		...
		private:
			 ...
			 *
			 * Tells too whether the drive is open for access (if non-null) or
			 * not (if null).
			 *
			 */
			...
			/**
			 * A CD-ROM drive object (CDROMDrive) will be associated uniquely to
			 * a CD-ROM device.
			 *
