...
/*
	...
	This file is adapted from its UNIX generated counterpart, OSDLConfig.h, and
	should be updated accordingly when the latter changes.

	The OSDLConfig.h in source control just includes this files when on
	Windows. On UNIX it is simply overwritten by the version generated by the
	autotools.
