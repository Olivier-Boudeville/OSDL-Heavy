...
/**
 * Tests the whole scheduling and rendering framework: the scheduler manages a
 * root renderer which is a multimedia renderer.
 *
 * This one uses an internal video renderer, and an internal audio renderer.
 *
 */
...
/**
 * Very basic multimedia renderer which just uses a list to store its registered
 * views.
 *
 */
