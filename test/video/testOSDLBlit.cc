...
int main( int argc, char * argv[] ) 
{
    ...
    try 
	{
		...
		Surface & offscreen = * new Surface( Surface::Software, /* width */ 100, 
			/* height */ 100, screen.getBitsPerPixel() ) ;
		...
		offscreen.blitTo( screen, TwoDimensional::Point2D( (short int) 400,250 ) ) ;
		screen.unlock() ;
