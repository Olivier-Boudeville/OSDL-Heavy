...
int main( int argc, char * argv[] )
{

  {
	...
	try
	{
	   ...
	   * automatically, but, for example purpose here, the pointer is kept so
	   * that the deallocation is triggered explicitly in user code. As this
	   * instance count should show, both types of deletion should work.
	   *
	   */
	  new TextWidget( screen,
