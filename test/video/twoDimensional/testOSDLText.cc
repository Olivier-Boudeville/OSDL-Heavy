...
/**
 * Small global tests for all graphical text output : useful to check at a glance that 
...
int main( int argc, char * argv[] ) 
{
    ...
    try 
	{
		...
		if ( ! Text::printBasic( 
			"This is a test for 'printBasic' primitive, which uses the built-in font.", screen,
				10, 40, Pixels::Tomato ) )
			throw Ceylan::TestException( "Test for 'printBasic' primitive failed" ) ;
		...
		Text::FixedFont myFixedFont( 9, 18, /* renderingStyle */ Text::Font::Bold, 
			/* convertToDisplay */ true, /* render cache */ Text::Font::None ) ;
					
		LogPlug::info( "Successfully loaded following font : " + myFixedFont.toString() ) ;
		...
		const string secondTestSentence = 
			"I hope so, coz it was quite a nightmare to have it all workin'"	;		

		Text::Font::RenderQuality quality = /* Text::Font::Solid */ Text::Font::Blended ;
		Text::Font::RenderCache cache = /* Text::Font::None */ Text::Font::WordCached ;
		...
		LogPlug::info( "Successfully loaded following font : " + myFirstTrueTypeFont.toString() ) ;

		myFirstTrueTypeFont.blitLatin1Text( screen, 10, 100, firstTestSentence,
			quality, Pixels::Orchid ) ;
			
		myFirstTrueTypeFont.blitLatin1Text( screen, 10, 140, secondTestSentence,
			quality, Pixels::Orchid ) ;
		...
		LogPlug::info( "Successfully loaded following font : " + mySecondTrueTypeFont.toString() ) ;

		mySecondTrueTypeFont.blitLatin1Text( screen, 10, 200, firstTestSentence,
			quality, Pixels::HotPink ) ;
			
		mySecondTrueTypeFont.blitLatin1Text( screen, 10, 240, secondTestSentence,
			quality, Pixels::HotPink ) ;
		...
		LogPlug::info( "Successfully loaded following font : " + myThirdTrueTypeFont.toString() ) ;
		...
		LogPlug::info( "Successfully loaded following font : " + myFourthTrueTypeFont.toString() ) ;

		myFourthTrueTypeFont.blitLatin1Text( screen, 10, 400, firstTestSentence,
			quality, Pixels::LawnGreen ) ;
			
		myFourthTrueTypeFont.blitLatin1Text( screen, 10, 440, secondTestSentence,
			quality, Pixels::LawnGreen ) ;
